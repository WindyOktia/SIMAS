...
<div class="card mb-3 ">
    ...
    <div class="card-body">
                ...
                <div class="position-relative form-group ml-3">
                    <div class="form-row ml-3"> 
                        <?php foreach ($jawaban as $jawab):?>
                            ...
                            <input type="radio" id="exampleCustomRadio1<?=$i?>" name="opsi[<?=$i?>]" value="<?= $jawab['id_jawaban']; ?>" class="">
        ...
        <div class="form-group">
            <button type="submit" class="btn btn-primary float-right mb-3 mt-3 aksi" name="signup" value="Sign up">Submit</button>
        </div>
    </div>
    <!-- end soal -->
</div>    
